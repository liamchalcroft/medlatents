"""Generation script for Bayesian Flow Networks."""
...
def generate_samples(
    ...
    """Generate samples using Bayesian Flow sampling."""
    model.eval()
    all_samples = []
...
def main():
    parser = argparse.ArgumentParser(description="Generate samples from BFN model")
    ...
    num_steps = hparams.get("num_steps", 1000)
